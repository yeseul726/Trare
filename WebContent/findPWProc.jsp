...
<body>
	<%
		...
		String sql = "SELECT user_pw FROM trb_member WHERE user_name='" + user_name + "' and user_id='" + user_id + "' and user_email='" + user_email + "'";
	...
	<script>alert("<%= user_name %>님의 비밀번호는 '<%= user_pw %>' 입니다."); location.href="index.jsp";</script>
</body>
</html>
